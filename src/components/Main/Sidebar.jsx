...
const Sidebar = () => {
  const [activeSidebarBtn, setActiveSidebarBtn] = useState(0);
  const handleSidebarItemClick = (index) => {
    setActiveSidebarBtn(index);
  };
  // SVG icons
  ...
  return (
    <>
      <aside id="content-sidebar">
        ...
        <ul>
          <li
            className={`sidebar-btn ${activeSidebarBtn === 0 ? "active" : ""}`}
          ...
          <li
            className={`sidebar-btn ${activeSidebarBtn === 1 ? "active" : ""}`}
          ...
          <li
            className={`sidebar-btn ${activeSidebarBtn === 2 ? "active" : ""}`}
