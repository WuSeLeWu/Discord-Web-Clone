          ...
          <div className="main-content-wrapper">
              ...
              <div className="left-items-wrapper">
                ...
                <ul class="nav nav-pills " id="pills-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      class="nav-link top-nav-item active"
                      id="pills-home-tab"
                      data-bs-toggle="pill"
            ...
            <div className="content">
                            ...
                            <div key={index} className="friends-item">
                              <div className="left-f">
                                <div className="img-wrapper">
                                  ...
                                  />
                                  <img
                                    src="/images/cevrimdisiStatus.png"
                                    alt="status"
                                    className="abcd"
                                  />
                                </div>
                  ...
                  >
                    <div className="tab-pane-wrapper justify-content-start">
                      ...
                      <div className="search-friends-input-wrapper">
                        ...
                        />
                        <button
                          className={inputValue ? "button-hover-enabled" : ""}
                          style={{
              ...
              <section className="right-section d-sm-none d-md-flex">
                ...
                <p>
                  Bir arkadaşın, bir oyun oynamak veya sesli sohbete katılmak
                  gibi bir etkinliğe başladığında burada göstereceğiz!
                </p>
              </section>
            </div>
          </div>
